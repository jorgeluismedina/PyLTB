...
# Secciones
sect1 = ISection_MS(h=0.3, bf1=0.20, bf2=0.20, tw=0.01, tf1=0.015, tf2=0.015, r1=0.0, r2=0.0, It_type="plates") #[m]
sect2 = ISection_MS(h=0.2, bf1=0.15, bf2=0.15, tw=0.01, tf1=0.015, tf2=0.015, r1=0.0, r2=0.0, It_type="plates") #[m]
